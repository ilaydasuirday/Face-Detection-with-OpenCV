...
public class FaceDetection {
    ...
    public static void main(String[] args) {
        ...
        CascadeClassifier cascadeMouthClassifier = new CascadeClassifier(FaceDetection.class.getResource("/haarcascade_smile.xml").getPath());
        //Start webcam
        ...
        if (videoDevice.isOpened()) {
            while (true) {
			   ...
			   MatOfRect mouth = new MatOfRect();
                ...
                System.out.println(String.format("%s face %s eye %s mouth detected.", faces.toArray().length, eyes.toArray().length, mouth.toArray()));
            }
        } else {
