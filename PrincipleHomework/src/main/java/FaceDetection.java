...
public class FaceDetection {
    ...
    public static void main(String[] args) {
        ...
        CascadeClassifier cascadeFaceClassifier = new CascadeClassifier(FaceDetection.class.getResource("/haarcascade_frontalface_default.xml").getPath());
        CascadeClassifier cascadeEyeClassifier = new CascadeClassifier(FaceDetection.class.getResource("/haarcascade_eye.xml").getPath());
        CascadeClassifier cascadeNoseClassifier = new CascadeClassifier(FaceDetection.class.getResource("/haarcascade_mcs_nose.xml").getPath());
        CascadeClassifier cascadeMouthClassifier = new CascadeClassifier(FaceDetection.class.getResource("/haarcascade_mcs_mouth.xml").getPath());
        //Start webcam
        ...
        if (videoDevice.isOpened()) {
            while (true) {
			   ...
			   MatOfRect mouth = new MatOfRect();
                ...
                System.out.println(String.format("%s face %s eye %s nose %s mouth detected.", faces.toArray().length, eyes.toArray().length, nose.toArray().length, mouth.toArray()));
            }
        } else {
