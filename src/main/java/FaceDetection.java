...
public class FaceDetection {
    ...
    public static void main(String[] args) {
        ...
        CascadeClassifier cascadeFaceClassifier = new CascadeClassifier("resources/haarcascade_frontalface_default.xml");
        CascadeClassifier cascadeEyeClassifier = new CascadeClassifier("resources/haarcascade_eye.xml");
        CascadeClassifier cascadeMouthClassifier = new CascadeClassifier("resources/haarcascade_smile.xml");
        //Start webcam
